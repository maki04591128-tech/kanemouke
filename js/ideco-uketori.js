(function () {
  ...
  function render() {
    ...
    var deduction = retirementDeduction(contribYears);
  ...
  [els.amount, els.contribYears, els.payoutYears, els.ageGroup, els.annuityRate, els.investRate, els.lumpRatio].forEach(
    function (el) {
